...
const leg = (
  [knee, ankle, toe]: readonly [Pt, Pt, Pt],
  fill: string,
  claw: string,
) => {
  const [kx, ky] = knee;
...
const scarf = (p: Palette) => {
  ...
  const tailA =
    'M82 -106C62 -116 44 -104 26 -112L24 -99C42 -90 60 -100 80 -92Z';
  const tailB = 'M82 -95C66 -98 56 -84 42 -89L40 -77C54 -71 68 -84 82 -84Z';
  const stripe =
    'M50 -110l-1 12M40 -109l-1 12M60 -91l-1 11M50 -87l-1 10M80 -106l11 -7M90 -92l11 -8M100 -78l11 -8';
  const fringe =
    'M24 -110l-7 -2M24 -105l-7 0M24 -100l-7 2M40 -87l-6 -2M40 -82l-6 0M40 -78l-6 2';
...
const stances = {
  ...
  string,
  Record<'far' | 'near', readonly [Pt, Pt, Pt]>
>;
