...
export const NextAuthSVG = (props: TSvgProps) => {
    ...
    return (
        <svg
            ...
            <path
                ...
                fill='url(#nextauth-paint0_linear_128_61)'
                fillRule='evenodd'
            />
            <path
                clipRule='evenodd'
                ...
                fill='url(#nextauth-paint1_linear_128_61)'
                fillRule='evenodd'
            />
            <path
                ...
                fill='url(#nextauth-paint2_linear_128_61)'
                fillOpacity='0.21'
            />
            <ellipse
                cx='104.905'
            ...
            <path
                ...
                fill='url(#nextauth-paint3_linear_128_61)'
                fillRule='evenodd'
            />
            <defs>
                <linearGradient
                    gradientUnits='userSpaceOnUse'
                    id='nextauth-paint0_linear_128_61'
                    x1='19.5695'
                    x2='97.5269'
                    y1='96.5644'
                    y2='15.0782'>
                ...
                <linearGradient
                    gradientUnits='userSpaceOnUse'
                    id='nextauth-paint1_linear_128_61'
                    x1='73.7856'
                    x2='170.671'
                    y1='143.724'
                    y2='190.884'>
                ...
                <linearGradient
                    gradientUnits='userSpaceOnUse'
                    id='nextauth-paint2_linear_128_61'
                    x1='155.914'
                    x2='155.914'
                    y1='21.8152'
                    y2='182.542'>
                ...
                <linearGradient
                    gradientUnits='userSpaceOnUse'
                    id='nextauth-paint3_linear_128_61'
                    x1='90.1481'
                    x2='129.287'
                    y1='99.4517'
                    y2='138.912'>
