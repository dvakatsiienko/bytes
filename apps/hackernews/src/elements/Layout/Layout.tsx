...
const Container = styled.section`
  ...
  display: grid;
  grid-template-columns: minmax(5px, var(--layout-h-offset)) 1fr minmax(5px, var(--layout-h-offset));
  grid-template-rows: minmax(10px, var(--layout-v-offset)) 1fr minmax(10px, var(--layout-v-offset));
  grid-template-areas:
    ".    .    ."
    ". browser ."
    ".    .    .";
