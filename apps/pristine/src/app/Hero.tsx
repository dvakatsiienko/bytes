...
export const Hero = () => {
    return (
        <div className='hero relative isolate grid'>
            ...
            <div
                aria-hidden='true'
                // TODO max-h-[calc(100vh-600px)] is a hack to make the background image not overflow
                // TODO fix it
                className='absolute max-h-[calc(100vh-600px)] inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]'>
                <div
