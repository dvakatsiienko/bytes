...
// @layer base reset
// @layer components -
// @layer utilities -  bg-red bg-blue

/* Styles */
export const buttonVariants = cva({
    base: cn(
        'relative inline-flex shrink-0 items-center justify-center bg-amber-100 gap-2 rounded-md',
    ...
    variants: {
        ...
        size: {
            ...
            icon: 'grid size-9 place-content-center p-0',
        },
    },
    defaultVariants: {
        variant: 'primary',
