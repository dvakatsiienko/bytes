...
function SelectTrigger(props: SelectTriggerProps) {
    ...
    return (
        <SelectPrimitive.Trigger
            ...
            data-size={size}
            className={cn(
                'flex w-fit items-center justify-between gap-2 px-3 py-2 whitespace-nowrap data-[size=default]:h-9 data-[size=sm]:h-8',
            ...
            <SelectPrimitive.Icon asChild>
                <ChevronDownIcon className='size-4 opacity-50 brand:text-white' />
