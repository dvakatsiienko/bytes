  ...
  overrides: [
    {
      ...
      extends: [
        ...
        // './rewires/rewiredStylisticRuleSet', // ? Enable this when @typescript-eslint v6 is released.
      ],
      ...
      rules: {
        ...
        ], // ! Because in default config «allowSingleExtends» is false, and in that case empty interface that extends is replaced by prettier to «type = Extension».
        ...
        '@typescript-eslint/no-unused-expressions': getJsRule(
          'no-unused-expressions',
        ),
        'no-unused-vars': 0,
        '@typescript-eslint/no-unused-vars': getJsRule('no-unused-vars'),
        'no-useless-constructor': 0,
        '@typescript-eslint/no-useless-constructor': getJsRule(
        ...
        '@typescript-eslint/member-delimiter-style':
          complexTsRules.memberDelimiterStyle, // ? Does not have ESLint equivalent
        ...
        '@typescript-eslint/object-curly-spacing': getJsRule(
        ...
        '@typescript-eslint/space-before-blocks': getJsRule(
          'space-before-blocks',
        ),
        'space-before-function-paren': 0,
        '@typescript-eslint/space-before-function-paren': getJsRule(
        ...
        '@typescript-eslint/type-annotation-spacing':
          complexTsRules.typeAnnotationSpacing,
      },
    },
  ],
};
